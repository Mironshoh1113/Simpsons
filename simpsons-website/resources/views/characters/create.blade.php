...
<head>
    ...
    <title>Yangi Qahramon Qo'shish - Simpsonlar</title>
...
<body class="min-h-screen">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="simpson-card p-8">
            <h2 class="text-3xl font-bold text-center mb-8 text-gray-800">➕ Yangi Qahramon Qo'shish</h2>
            ...
            <form action="{{ route('characters.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="image" class="block text-lg font-semibold text-gray-700 mb-2">🖼️ Rasm</label>
                        <input type="file" 
                               id="image" 
                               name="image" 
                               accept="image/*"
